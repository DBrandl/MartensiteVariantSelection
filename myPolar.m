...
%    for i=(rmin+rinc):rinc:rmax
        hhh = plot(xunit*rmax,yunit*rmax,ls,'color',tc,'linewidth',2,...
                   'handlevisibility','off');
%         text((rmax+rinc/20)*c82,(rmax+rinc/20)*s82, ...
%             ['  ' num2str(rmax)],'verticalalignment','bottom',...
%             'handlevisibility','off')
%    end
    set(hhh,'linestyle','-') % Make outer circle solid

% plot spokes (radial dotted lines)
    th = (1:6)*2*pi/12;
...
if strcmp(line_style,'auto')
    ...
    p  = patchline(xx,yy,'linestyle','-','edgecolor',line_style(1),...
        'linewidth',2,'edgealpha',0.6); % linewidth 2
